...
<body style="<?=$style['body']?>">
	...
	<div style="<?=$style['box1']?>">
		<span style="<?=$style['normal']?>">
			...
			<?php } ?>
			<br /><br />
			Our free Pick of the Week is in the following game:<br /><br />
			...
			<?php } ?>
			<br />
			Please keep in mind that this is our lowest rated pick for Week <?=$r['week']?>. Our other picks are now available for purchase, please visit <a href="<?=$url_proto?>://<?=$maindw?>/purchases/"><?=$maind?>/purchases</a>.
			<br /><br />
