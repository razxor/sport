var M = {
	...
	e: {
		...
		dup_y: 'Already has an order for this season',
		dup_w: 'Already has an order for this week'
	},
	m: {
		'ok': 'Data saved'
	},
	...
	AD: function(id) {
		return Ui.Confirm('Delete order?', 'Delete', "Don't delete", (function(id) { return M.D(id); }).bind(null, id));
	},
	D: function(id) {
