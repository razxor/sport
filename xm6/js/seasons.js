var M = {
	...
	p: 1,
	e: {
		s_date: 'Enter the start date',
		e_date: 'Enter the end date',
		date_b: 'Dates are in a bad order'
	},
	m: {
		'ok': 'Data saved'
	},
	...
	AD: function(id) {
		return Ui.Confirm('Delete season?', 'Delete', "Don't delete", (function(id) { return M.D(id); }).bind(null, id));
	},
	D: function(id) {
